...
def test_ultragoal_materializes_durable_checkpoint_with_goal_context(tmp_path: Path) -> None:
    ...
    result = run_workflow_harness_smoke("ultragoal", _payload(), tmp_path)
...
def test_ultragoal_checkpoint_is_idempotent_and_blocks_tampered_goals(tmp_path: Path) -> None:
    ...
    first = run_workflow_harness_smoke("ultragoal", _payload(), tmp_path)
    ...
    second = run_workflow_harness_smoke("ultragoal", _payload(), tmp_path)
