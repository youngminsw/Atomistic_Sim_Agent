...
def default_tool_registry() -> ToolRegistry:
    ...
    return ToolRegistry(
        tools=(
            ...
            ToolDefinition("validate_simulation_request", "schema", parameters=_object_schema({}, ())),
            ToolDefinition("geometry_ingestion", "geometry", parameters=_object_schema({}, ())),
            ToolDefinition("md_campaign_planning", "md", parameters=_object_schema({}, ())),
            ToolDefinition("surrogate_status", "mdn", parameters=_object_schema({}, ())),
            ToolDefinition("feature_transport", "transport", parameters=_object_schema({}, ())),
            ToolDefinition("level_set_evolution", "profile", parameters=_object_schema({}, ())),
            ToolDefinition("compute_routing", "compute", parameters=_object_schema({}, ())),
            ToolDefinition("artifact_manifest", "evidence", parameters=_object_schema({}, ())),
            ToolDefinition("literature_registry", "graphdb", parameters=_object_schema({}, ())),
            ToolDefinition("research_source_lookup", "graphdb", parameters=_object_schema({}, ())),
            ToolDefinition("source_graph_import_bundle", "graphdb", parameters=_object_schema({}, ())),
            ToolDefinition("graphdb_ingest_report", "graphdb", parameters=_object_schema({}, ())),
            ToolDefinition("ui_run_status", "html_ui", parameters=_object_schema({}, ())),
        )
    )
