...
MODEL_PROFILES: Final[tuple[ModelProfile, ...]] = (
    ModelProfile(
        ...
        agents=(
            ...
            ModelProfileAssignment("ml_agent", "openai-codex", "gpt-5.5", "low"),
            ModelProfileAssignment("feature_scale_agent", "openai-codex", "gpt-5.5", "low"),
            ModelProfileAssignment("research_agent", "openai-codex", "gpt-5.5", "medium"),
    ...
    ModelProfile(
        ...
        agents=(
            ...
            ModelProfileAssignment("ml_agent", "openai-codex", "gpt-5.5", "medium"),
            ModelProfileAssignment("feature_scale_agent", "openai-codex", "gpt-5.5", "medium"),
            ModelProfileAssignment("research_agent", "openai-codex", "gpt-5.5", "high"),
    ...
    ModelProfile(
        ...
        agents=(
            ...
            ModelProfileAssignment("ml_agent", "openai-codex", "gpt-5.5", "high"),
            ModelProfileAssignment("feature_scale_agent", "openai-codex", "gpt-5.5", "high"),
            ModelProfileAssignment("research_agent", "openai-codex", "gpt-5.5", "xhigh"),
            ModelProfileAssignment("qa_agent", "openai-codex", "gpt-5.5", "xhigh"),
        ),
    ),
)
